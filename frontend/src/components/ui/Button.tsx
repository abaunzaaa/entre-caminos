  ...
  return (
    <button
      className={cn(
        ...
        variant !== "primary" &&
          "admin-cta-hover inline-flex items-center justify-center rounded-full font-poppins font-medium tracking-[0.03em] disabled:cursor-not-allowed disabled:opacity-50",
        ...
        variant === "secondary" && "border border-forest/15 bg-white text-ink",
        variant === "ghost" && "text-forest",
